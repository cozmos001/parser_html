...
# Вторая часть URL с конкретным поиском(например Django, SQLAlchemy и т.д.)
# Вариант с запросом у пользователя
# search = input('Введите слово для поиска')
search = 'SQLAlchemy'  # Django Библиотеки
# url = '/feed/?q=Django'
# url = '/feed/?q=Библиотеки'
url = f'/feed/?q={search}'
